package com.app.ravi.integrationtest;
...
class ControllerTest {
  ...
  void  testRetrieveMetadataDocument() {
    ...
    assertNotNull(n);
    assertEquals("ravi", n.getAttribute("Namespace"));
  ...
  @AfterEach
  void  teardown() {
    jdbcTemplate.execute("DELETE FROM ravi_783.PetService");
    jdbcTemplate.execute("DELETE FROM ravi_783.PetOwner");
    jdbcTemplate.execute("DELETE FROM ravi_783.PetCareCenter");
    jdbcTemplate.execute("DELETE FROM ravi_783.Manager");
    jdbcTemplate.execute("DELETE FROM ravi_783.Document");
    jdbcTemplate.execute("DELETE FROM ravi_783.Pet");
     jdbcTemplate.execute("DELETE FROM ravi_783.PetCareCenterServices");
     jdbcTemplate.execute("DELETE FROM ravi_783.PetCareCenterBusinessHours");
     jdbcTemplate.execute("DELETE FROM ravi_783.PetOwnerPets");
     jdbcTemplate.execute("DELETE FROM ravi_783.PetCareCenterImages");
     jdbcTemplate.execute("DELETE FROM ravi_783.PetCareCenterPets");
